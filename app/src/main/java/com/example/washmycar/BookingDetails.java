...
//            URL url = new URL("http://192.168.43.118/washmycar/index.php/androidcontroller/get_carwash_station");
            ...
            for(int i=0; i<array.length(); i++){
                ...
                list.add(new BookingDetailsList(Customer_image,customer_name,customer_date,customer_time,customer_service,employee,station,price,status,transaction_id,sek_id));
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        String seeker_id = selectedItem.getSeek_id();
...
//        String schedule_id = getIntent().getStringExtra("schedule_id");
       String ID = selectedItem.getId();
            Intent intent = new Intent(this, BookingDetailsCancel.class);
